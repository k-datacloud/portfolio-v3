...
const mainScript = () => {
  ...
  if (window.location.pathname === "/info") {
    ...
    chars.forEach((char) => {
      ...
      span.classList.add("c-char--info");
      span.textContent = char;
      infoFvTitle.appendChild(span);
    });
    const infoFvTitleChars = document.querySelectorAll(".c-char--info");
    const timeline = gsap.timeline();
  ...
  function updateDisplay() {
    ...
    document.querySelectorAll(".js-datetime").forEach((time) => {
